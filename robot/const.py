...
DRIVE_BASE_WIDTH = 26
DRIVE_BASE_LENGTH = 26
DRIVE_BASE_RADIUS_METERS = 0.381660882
DRIVETRAIN_TRACKWIDTH_METERS = 0.53975
DRIVETRAIN_WHEELBASE_METERS = 0.53975

SWERVE_WHEEL_CIRCUMFERENCE = math.pi * (4 * 2.54 / 100)  # C = pi*d
SWERVE_DRIVE_GEAR_RATIO = 4.59  # From belt kit we ordered
SWERVE_ANGLE_GEAR_RATIO = 13.3714  # From Swerve X user guide, for flipped, belt models


SWERVE_MAX_SPEED = 6.8  # meters per second
...
SWERVE_ANGLE_OFFSET_FRONT_LEFT = Rotation2d.fromDegrees(-111.01)  # 234.4
SWERVE_DRIVE_MOTOR_ID_FRONT_LEFT = 10
SWERVE_ANGLE_MOTOR_ID_FRONT_LEFT = 11
SWERVE_CANCODER_ID_FRONT_LEFT = 12  # 8
...
SWERVE_ANGLE_OFFSET_FRONT_RIGHT = Rotation2d.fromDegrees(125.24)  # 235.37
SWERVE_DRIVE_MOTOR_ID_FRONT_RIGHT = 14
SWERVE_ANGLE_MOTOR_ID_FRONT_RIGHT = 13
SWERVE_CANCODER_ID_FRONT_RIGHT = 15  # 5
SWERVE_DRIVE_INVERT_FRONT_RIGHT = signals.InvertedValue(1)
SWERVE_ANGLE_INVERT_FRONT_RIGHT = signals.InvertedValue(0)


# Module Back Right

SWERVE_ANGLE_OFFSET_BACK_RIGHT = Rotation2d.fromDegrees(97.91)  # 5.80
SWERVE_DRIVE_MOTOR_ID_BACK_RIGHT = 16
SWERVE_ANGLE_MOTOR_ID_BACK_RIGHT = 17
SWERVE_CANCODER_ID_BACK_RIGHT = 18  # 2
SWERVE_DRIVE_INVERT_BACK_RIGHT = signals.InvertedValue(0)
SWERVE_ANGLE_INVERT_BACK_RIGHT = signals.InvertedValue(1)

# Module Back Left
SWERVE_ANGLE_OFFSET_BACK_LEFT = Rotation2d.fromDegrees(-21.01)  # 339.96
SWERVE_DRIVE_MOTOR_ID_BACK_LEFT = 20
SWERVE_ANGLE_MOTOR_ID_BACK_LEFT = 19
SWERVE_CANCODER_ID_BACK_LEFT = 21  # 11
SWERVE_DRIVE_INVERT_BACK_LEFT = signals.InvertedValue(1)
SWERVE_ANGLE_INVERT_BACK_LEFT = signals.InvertedValue(0)
