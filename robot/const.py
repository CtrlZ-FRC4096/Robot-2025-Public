...
END_EFFECTOR_REEF_ALIGNMENT_CANRANGE = 14
...
CLIMBER_INTAKE_MOTOR_CAN_ID = 22
...
CAM_DICT = {
    "camera_1": (
        np.array([0.038, -0.007, 0.0, -0.001, -0.12, -0.002, 0.0, 0.005], dtype=np.float64),
        np.array([[915.97, 0.0, 629.32],
			[0.0, 916.30, 382.39],
	...
	"camera_4": (
        np.array([0.044, -0.055, -0.001, -0.001, -0.016, -0.002, 0.002, 0.001], dtype=np.float64),
        np.array([[912.14, 0.0, 669.97],
			[0.0, 912.51, 376.64],
			[0.0, 0.0, 1.0]], dtype=np.float64),
    )
}
